...
- The four live matrix/research slides add `../Figures/stew.png` and the author's exact recipe captions as italic quotations in a shared HTML header (`../index.qmd`, `../theme.scss`). The supplied screenshot is copied unchanged. The figure generators leave the header clear and shift the full-size diagrams down by 4.5% of slide height. These captions replace the earlier titles; the research sublabels and all matrix/map content remain.
