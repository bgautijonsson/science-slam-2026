...
- The nine-estimates slide omits “Lower → higher”. Three exclusive native fragments fade the two unselected columns in Level → Spread → Tail order, aligned with the fixed 70%, 81%, 92% column centres. Mouse clicks and forward/backward keys step through the comparisons; the following click advances to Gauss.
