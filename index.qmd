...
Introduce yourself, give the name of your PhD project and name your advisor in your own words. This opening can stay on screen while you settle in. Introduce the topic lightly: the wettest hour of the year. Keep the full comic title for the next slide. Advance once when you are ready for the whole audience to see the poster together.
:::
...
Reveal the full poster and comic title together. Give the audience a moment to take it in and let the joke land before moving on. The self-introduction belongs on the preceding slide, so the poster gets its own beat. Then move to the rainfall photograph and why predicting changes matters.
:::
...
Reveal the new closing poster. Hold it, finish, and stop. Do not introduce another scientific point. Author-supplied artwork, hessian_ending.png, added 24 September 2026; the complete image is shown without cropping.
:::
