...
Start with all nine estimates visible. Click once to focus on Level (location), twice for Spread (scale), and three times for Tail (shape). Each step fades the other two columns while keeping the station names and rainfall records visible. The fourth click advances to Gauss; the left arrow reverses the steps.
