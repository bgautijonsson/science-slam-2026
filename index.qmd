...
```{=html}
  <div class="hessian-rest" style="background-image: url('design-studies/designs/hessian-panorama.png')" aria-hidden="true"></div>
  <span class="uncertainty-reveal fragment" data-fragment-index="0" aria-hidden="true"></span>
```
::::
...
Click: Hessian = curvature at the summit → normal approximation
